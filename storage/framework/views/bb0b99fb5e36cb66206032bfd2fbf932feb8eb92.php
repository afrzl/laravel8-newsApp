...
<div class="col-lg-8">
    <form action="/dashboard/posts/<?php echo e($post->slug); ?>" method="post" class="mb-5" enctype="multipart/form-data">
...
unset($__errorArgs, $__bag); ?>" name="title" id="title"
                required autofocus value="<?php echo e(old('title', $post->title)); ?>">
...
<?php echo $__env->make('dashboard.layouts.main', \Illuminate\Support\Arr::except(get_defined_vars(), ['__data', '__path']))->render(); ?><?php /**PATH C:\laragon\www\coba-laravel\resources\views/dashboard/posts/edit.blade.php ENDPATH**/ ?>